    ...
    <section id="services" className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          <h2 className="text-4xl text-center font-bold text-gray-600 py-5">
            Våre Tjenester
          </h2>
          <h3 className="text-gray-600">
Vi tilbyr nøkkeltjenester som hjelper deg med å vokse raskere, smartere og mer målrettet. <br /> Hver tjeneste skreddersys til din forretningsmodell og ditt vekstnivå.
          </h3>
        </div>
        <div className="flex justify-center items-center gap-x-5 gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <h4 className="text-lg font-medium text-gray-600 mb-3 capitalize">
              AI-drevet Forretningsvekst
            </h4>
            <p className="text-sm font-normal text-gray-500">
             Vi integrerer AI og automatisering i driften av selskapet ditt for å gi deg et tydelig konkurransefortrinn. Dette inkluderer:<br />
              AI-chatboter og automasjonsverktøy,<br />
              Prediktiv analyse for markedsinnsikt,<br />
              AI-baserte markedsføringsstrategier
            </p>
          </div>
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <h4 className="text-lg font-medium text-gray-600 mb-3 capitalize">
              Web- og Programvareutvikling
            </h4>
            <p className="text-sm font-normal text-gray-500">
             Din digitale tilstedeværelse er avgjørende for vekst og tillit. Vi utvikler skreddersydde løsninger som:<br />
              Nettsider og webapper (f.eks. Webflow, Shopify, custom kode),<br />
              Mobilapper<br />
              SaaS- og plattformutvikling
            </p>
          </div>
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <p className="text-sm font-normal text-gray-500">
             Bygg en merkevare som folk husker og stoler på. Vi hjelper deg med:<br />
              Visuell identitet og logo,<br />
             Merkevarehistorie og strategisk kommunikasjon<br />
             Markedsstrategi og SEO-optimalisering
            </p>
          </div>
          ...
          <div className="relative w-full text-center max-md:max-w-sm max-md:mx-auto group md:w-2/5 lg:w-1/4">
            ...
            <h4 className="text-lg font-medium text-gray-600 mb-3 capitalize">
             Vekststrategi og strukturering
            </h4>
            <p className="text-sm font-normal text-gray-500">
              Vi hjelper deg å gjøre selskapet vekstklart gjennom:<br />
              Forretningsmodelloptimalisering,<br />
              Pitch decks og investorklargjøring,<br />
             Salgsstrategi og growth hacking, <br />
             Riktig struktur for å skalere
            </p>
          </div>
